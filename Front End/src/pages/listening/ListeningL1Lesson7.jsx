...
/**
 * Listening Module L1 Lesson 7: Tense Consistency Error
 */
const ListeningL1Lesson7 = () => {
  ...
  const incorrectSentence = "My friend have completed the project yesterday.";
  const correctAnswer = "My friend completed the project yesterday.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 7: Tense Consistency Error</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> "Yesterday" indicates past tense. Use simple past "completed" instead of present perfect "have completed."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson7;
