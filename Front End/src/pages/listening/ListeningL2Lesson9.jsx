...
/**
 * Listening Module L2 Lesson 9: Meeting Announcement
 */
const ListeningL2Lesson9 = () => {
  ...
  const scenario = "Inform your team about an important meeting scheduled tomorrow morning.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l9');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 9: Meeting Announcement</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="tips-section">
              ...
              <ul>
                <li>Be clear about time and location</li>
                <li>State purpose</li>
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Hi team, I wanted to inform you that we have an important meeting scheduled for tomorrow morning at 10 AM in Conference Room B. We'll be discussing [topic]. Please confirm your attendance and come prepared with any questions or updates. See you there!"
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson9;
