...
/**
 * Listening Module L1 Lesson 9: Each/Every Agreement
 */
const ListeningL1Lesson9 = () => {
  ...
  const correctAnswer = "Each of the students has submitted their reports.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 9: Each/Every Agreement</h2>
          </div>
...
export default ListeningL1Lesson9;
