...
/**
 * Listening Module L2 Lesson 4: Team Congratulations
 */
const ListeningL2Lesson4 = () => {
  ...
  const scenario = "Congratulate your team on completing a major project successfully.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l4');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 4: Team Congratulations</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Team, I want to take a moment to congratulate all of you on the successful completion of the [Project Name]. Your hard work, dedication, and collaboration made this possible. This achievement reflects our team's commitment to excellence. Let's keep this momentum going!"
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson4;
