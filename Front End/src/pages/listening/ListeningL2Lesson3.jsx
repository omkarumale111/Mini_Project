...
/**
 * Listening Module L2 Lesson 3: Leave Request
 */
const ListeningL2Lesson3 = () => {
  ...
  const scenario = "Politely ask your manager for a short leave due to a personal reason.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l3');
          ...
          <div className="exercise-section">
            ...
            <div className="tips-section">
              ...
              <ul>
                <li>Be respectful</li>
                <li>Provide dates</li>
                <li>Offer to complete pending work</li>
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Good morning [Manager Name], I would like to request a short leave from [date] to [date] due to a personal matter. I will ensure all my pending tasks are completed before I leave, and I'm happy to brief a colleague if needed. Thank you for your understanding."
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson3;
