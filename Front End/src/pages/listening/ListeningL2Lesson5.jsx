...
/**
 * Listening Module L2 Lesson 5: Delay Notification
 */
const ListeningL2Lesson5 = () => {
  ...
  const scenario = "Explain to a client that their project delivery might be delayed and apologize professionally.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l5');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 5: Delay Notification</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="tips-section">
              ...
              <ul>
                ...
                <li>Explain reason briefly</li>
                <li>Provide new timeline</li>
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Dear [Client Name], I sincerely apologize for informing you that we may experience a slight delay in delivering your project. Due to [brief reason], we need an additional [time period]. We're working diligently to minimize this delay and will keep you updated on our progress."
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson5;
