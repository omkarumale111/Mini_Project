...
/**
 * Listening Module L1 Lesson 5: Past Tense Error
 */
const ListeningL1Lesson5 = () => {
  ...
  const incorrectSentence = "He did not told me about the problem.";
  const correctAnswer = "He did not tell me about the problem.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 5: Past Tense Error</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> After "did not," use the base form of the verb "tell," not the past tense "told."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson5;
