...
/**
 * Listening Module L2 Lesson 6: New Intern Welcome
 */
const ListeningL2Lesson6 = () => {
  ...
  const scenario = "Welcome a new intern joining your team for the first time.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l6');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 6: New Intern Welcome</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Welcome to the team! We're so glad to have you here. I'm [Your Name], and I'll be working closely with you during your internship. Please don't hesitate to ask any questions – we're all here to support you. Looking forward to working together!"
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson6;
