...
/**
 * Listening Module L1 Lesson 10: Preposition Usage Error
 */
const ListeningL1Lesson10 = () => {
  ...
  const incorrectSentence = "The manager discussed about the issue in detail.";
  const correctAnswer = "The manager discussed the issue in detail.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 10: Preposition Usage Error</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> The verb "discuss" is transitive and doesn't need the preposition "about."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson10;
