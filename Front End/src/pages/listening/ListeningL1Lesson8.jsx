...
/**
 * Listening Module L1 Lesson 8: Plural Subject Agreement
 */
const ListeningL1Lesson8 = () => {
  ...
  const incorrectSentence = "They was very tired after the journey.";
  const correctAnswer = "They were very tired after the journey.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 8: Plural Subject Agreement</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> "They" is plural, so use "were" instead of "was."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson8;
