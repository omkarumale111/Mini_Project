...
/**
 * Listening Module L1 Lesson 3: Comparative Adjective Error
 */
const ListeningL1Lesson3 = () => {
  ...
  const incorrectSentence = "She is more smarter than her brother.";
  const correctAnswer = "She is smarter than her brother.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 3: Comparative Adjective Error</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> "Smarter" is already the comparative form of "smart." Using "more" with "smarter" is redundant and incorrect.
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson3;
