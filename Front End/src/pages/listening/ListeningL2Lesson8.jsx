...
/**
 * Listening Module L2 Lesson 8: Customer Complaint Response
 */
const ListeningL2Lesson8 = () => {
  ...
  const scenario = "Respond to a customer complaint politely and assure them of a quick resolution.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l8');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 8: Customer Complaint Response</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "Dear [Customer Name], Thank you for bringing this to our attention. I sincerely apologize for the inconvenience you've experienced. I understand how frustrating this must be. I'm personally looking into this matter and will ensure it's resolved within [timeframe]. I'll keep you updated on the progress."
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson8;
