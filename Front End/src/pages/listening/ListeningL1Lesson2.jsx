...
/**
 * Listening Module L1 Lesson 2: Singular-Plural Mismatch
 */
const ListeningL1Lesson2 = () => {
  ...
  const incorrectSentence = "The meeting are scheduled for tomorrow.";
  const correctAnswer = "The meeting is scheduled for tomorrow.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 2: Singular-Plural Mismatch</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> "The meeting" is singular, so it requires the singular verb "is" instead of the plural "are."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson2;
