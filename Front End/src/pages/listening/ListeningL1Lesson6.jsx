...
/**
 * Listening Module L1 Lesson 6: There Is/Are Agreement
 */
const ListeningL1Lesson6 = () => {
  ...
  const incorrectSentence = "There is five members in my team.";
  const correctAnswer = "There are five members in my team.";
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 6: There Is/Are Agreement</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="correct-answer-section">
              ...
              <div className="explanation">
                <strong>Explanation:</strong> "Five members" is plural, so use "there are" instead of "there is."
              </div>
            </div>
          </div>
...
export default ListeningL1Lesson6;
