...
/**
 * Listening Module L2 Lesson 7: Supervisor Appreciation
 */
const ListeningL2Lesson7 = () => {
  ...
  const scenario = "Thank your supervisor for guiding you during a difficult task.";
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      formData.append('lesson_id', 'L2l7');
      ...
      <div className="main-content">
        ...
        <div className="lesson-content">
          <div className="lesson-header">
            ...
            <h2>Lesson 7: Supervisor Appreciation</h2>
          </div>
          ...
          <div className="exercise-section">
            ...
            <div className="tips-section">
              ...
              <ul>
                <li>Be sincere</li>
                <li>Be specific about help received</li>
                <li>Express impact</li>
            ...
            <div className="example-section">
              ...
              <p className="example-text">
                "I wanted to take a moment to thank you for your guidance on the [task name]. Your insights and support were invaluable, especially when I was facing challenges with [specific issue]. Your mentorship has helped me grow professionally, and I truly appreciate it."
              </p>
            </div>
          </div>
...
export default ListeningL2Lesson7;
